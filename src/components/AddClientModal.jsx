 ...
 * @param {function} onClientCreated - Callback cuando se crea el cliente exitosamente
 */
const AddClientModal = ({ show, onHide, onClientCreated }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    phoneCountryCode: "+598", // Código por defecto para Uruguay
    marca: "",
    modelo: "",
    carTypeId: "",
  });
